...
var para = {
    ...
    musicList: [
       { songSheet: "我的歌单", name: "岁月神偷", src: "http://1256144948.vod2.myqcloud.com/c21d4b73vodtransgzp1256144948/2f30dd167447398154914509449/v.f10.mp4", author: "金玟岐" }
...
var audio = new Audio(
    function (tTime, formatTTime) {
        /*ttime  歌曲的总时间*/
        para.t_time = tTime;
        IdDom("t_timer").innerHTML = formatTTime;
        ...
        IdDom("percent_icon").style.left = percent + "%";  //底下的进度条
...
function setProgress() {
    //父元素绑定事件
    IdDom("play_bar").addEventListener("click", function (e) {
        if (!para.isFirstPlay) {//如果首次还没播放就快进，我们不予处理
            ...
            IdDom("percent_icon").style.left = (percent - 2) * 100 + "%";
